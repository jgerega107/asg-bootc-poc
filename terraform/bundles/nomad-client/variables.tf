...
variable "name" {
  description = "Name for the Nomad client ASG, instances, and IAM resources."
  type        = string
...
variable "instance_type" {
  description = "EC2 instance type for Nomad client instances."
  type        = string
  default     = "t3.micro"
}

variable "root_disk_size" {
  description = "Root disk size in GiB. Nomad stores client data on this disk."
  type        = number
  default     = 20
...
variable "root_disk_encrypted" {
  description = "Whether to encrypt Nomad client root disks with the default EBS key."
  type        = bool
  default     = true
}
...
variable "vpc_security_group_ids" {
  description = "Additional security groups to attach to Nomad client instances."
  type        = list(string)
  default     = []
}

variable "min_size" {
  description = "Minimum number of Nomad client instances in the Auto Scaling Group."
  type        = number
  default     = 1
...
variable "desired_capacity" {
  description = "Desired number of Nomad client instances in the Auto Scaling Group."
  type        = number
  default     = 1
...
variable "max_size" {
  description = "Maximum number of Nomad client instances in the Auto Scaling Group."
  type        = number
  default     = 1
...
variable "tags" {
  description = "Additional tags for Nomad client resources."
  type        = map(string)
  default     = {}
}
